...
public class aspiranteTab implements Serializable {
    ...
    public String toString() {
        return "aspiranteTab{" + "cedula=" + cedula + ", nombre=" + nombre + ", edad=" + edad + ", genero=" + genero + ", id_profesion=" + id_profesion + ", profesion=" + profesion + ", id_agencia=" + id_agencia + ", agencia=" + agencia + '}';
    }
